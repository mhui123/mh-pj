          ...
          <!-- <li>
            <a href="#">
              <svg class="video-player">
                <use xlink:href="#video-player"></use></svg
              ><span>Work</span></a
            >
          </li>
          ...
          <li>
            <a href="#">
              <svg class="paper-airplane">
                <use xlink:href="#paper-airplane"></use></svg
              ><span>Contact</span></a
            >
          </li> -->
        </ul>
